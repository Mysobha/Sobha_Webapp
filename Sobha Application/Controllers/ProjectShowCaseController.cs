...
{
    public class ProjectShowCaseController : Controller
    {
        private readonly ILogger<YourSobhaController> _logger;
        private readonly IConfiguration _configuration;
        public ProjectShowCaseController(ILogger<YourSobhaController> logger, IConfiguration configuration)
        {
            _logger = logger;
                ...
                try
                {
                    ...
                    if (response.IsSuccessStatusCode)
                    {
                        ...
                        if (response.IsSuccessStatusCode)
                        {
                            ...
                            var listid = sharePointList == null ? "" : sharePointList.value.FirstOrDefault(obj => obj.displayName == "Project Showcase").id;
