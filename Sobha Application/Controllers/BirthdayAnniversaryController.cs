...
{
    public class BirthdayAnniversaryController : Controller
    {
        private readonly ILogger<YourSobhaController> _logger;
        private readonly IConfiguration _configuration;
        public BirthdayAnniversaryController(ILogger<YourSobhaController> logger, IConfiguration configuration)
        {
            _logger = logger;
